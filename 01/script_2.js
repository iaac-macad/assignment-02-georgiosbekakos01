...
function init() {
    ...
    const loaderB = new Rhino3dmLoader()
    loaderB.setLibraryPath( 'https://cdn.jsdelivr.net/npm/rhino3dm@7.11.1/' )

    loaderB.load( 'agr_02.3dm', function ( object ) {

        document.getElementById('loaderB').remove()
...
function onClick( event ) {
    ...
    if (containerB) containerB.remove()
