...
function init() {
    ...
    tl.setPath('materials/PBR/ParquetFlooring09_MR_4K/')
    material = new THREE.MeshPhysicalMaterial()
    material.map          = tl.load('ParquetFlooring09_4K_BaseColor')
    //material.aoMmap       = tl.load('streaked-metal1_ao.png')
    material.normalMap    = tl.load('ParquetFlooring09_4K_Normal')
    //material.metalnessMap = tl.load('streaked-metal1_metallic.png')
    material.roughness = tl.load('ParquetFlooring09_4K_Roughness')
    ...
    loader.load( 'agr_01.3dm', function ( object ) {
